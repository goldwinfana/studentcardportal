    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header navbar-default">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><b>Stuff Profile</b></h4>
            </div>
            <div class="modal-body" style="display: grid;">
        ...
        $('.view-profile').on('click', function (){
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('.stuff-first').html(response.first_name);
                    $('.stuff-last').html(response.last_name);
                    $('.stuff-email').html(response.email);
                    $('.stuff-id').html(response.id_number);
