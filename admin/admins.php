        ...
        <div id="page-wrapper">
          ...
          ";
            ...
            <div class="row" style="margin: 25px 0px">
                <button class="btn btn-primary add-admin"><i class="fa fa-user-plus"></i> Add Admin</button>
            </div>
            ...
            <div class="row">
                    <table id="_table" class="table table-bordered table table-striped table-hover" style="width: 100%;">
                        ...
                        $query = $connect->open();
                        $sql = $query->prepare("SELECT * FROM admin");
                        $sql->execute();
                            ...
                            foreach ($sql as $data){
                                ...
                                echo '
                                     <tr>
                                        ...
                                        <td>
                                            <div class="d-flex" >
                                                <a id="'.$data["id"].'" class="action-btn btn-warning edit-admin" title="Edit"><i class="fa fa-pencil"></i></a>
                                                <a id="'.$data["id"].'" class="action-btn btn-danger delete-admin" title="Delete"><i class="fa fa-trash"></i></a>
                                            </div>
                                        </td>
                                     </tr>
                                ';
